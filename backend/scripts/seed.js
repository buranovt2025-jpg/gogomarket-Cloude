/**
 * GogoMarket Seed - plain JS, run: node scripts/seed.js
 */
...
const { users, sellers, categories, products, productPhotos, reels } = schema;
...
async function seed() {
  ...
  // ── Products ──────────────────────────────────────────────────────────────
  const productInputs = [
    { sellerId: aishaId,  categoryId: catMap['clothes'], isBoosted: true,
      title: 'Платье летнее с цветочным принтом',
      priceTiyin: 18500000, oldPriceTiyin: 25000000, saleCount: 145, viewCount: 3200,
    ...
    { sellerId: kamolaId, categoryId: catMap['beauty'], isBoosted: true,
    ...
    { sellerId: techId,   categoryId: catMap['tech'], isBoosted: true,
      title: 'Наушники TWS Pro',
    ...
    { sellerId: sportId,  categoryId: catMap['shoes'], isBoosted: true,
